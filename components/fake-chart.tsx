...
export function FakeChart() {
  ...
  return (
    <Card className='backdrop-blur-sm w-full'>
      <CardHeader className='flex sm:flex-row items-center gap-2 space-y-0 py-5 border-b'>
        <div className='flex-1 gap-1 grid text-center sm:text-left'>
          ...
          <CardDescription>نمایش تعداد بازدید کنندگان</CardDescription>
        </div>
        <Select value={timeRange} onValueChange={setTimeRange}>
          <SelectTrigger
            className='sm:ml-auto rounded-lg w-[160px] rtl'
            aria-label='Select a value'>
            <SelectValue placeholder='30 روز گذشته' />
          </SelectTrigger>
